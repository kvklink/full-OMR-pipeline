# -*- coding: utf-8 -*-
"""
Created on Fri Jun 12 16:39:09 2020
...
def detect_stafflines(img_bar):
    ...
    all_lines = sorted(calc_higher_lines(calc_lower_lines(unique_lines,dist,width),dist,width), key=lambda x: x[1])
