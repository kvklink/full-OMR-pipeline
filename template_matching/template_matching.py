...
img_rgb = cv.imread('/Users/kyle/Desktop/input.jpeg')
...
for select in selected:
    templates.append(cv.Canny(cv.cvtColor(cv.imread(template_dir + f'symbol{select}.png'), cv.COLOR_BGR2GRAY)), 50, 200)
